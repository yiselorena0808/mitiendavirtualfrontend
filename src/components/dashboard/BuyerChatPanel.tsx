  ...
  return (
    <div className="glass-panel animate-fade-in" style={{ display: 'flex', height: '600px', overflow: 'hidden' }}>
      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', background: 'var(--bg-primary)' }}>
        {selectedChat ? (
          <>
            <div style={{ padding: '1rem', borderBottom: '1px solid var(--border-color)', background: 'var(--bg-secondary)', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
              <h3 className="text-lg">Chat con {selectedChat.store?.name}</h3>
